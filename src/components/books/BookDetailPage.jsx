  ...
  return (
    ...
    <div className="min-h-[80vh] w-full flex flex-col justify-center items-center px-4 py-8 animate-fade-in">
      <div className="w-full max-w-3xl space-y-4">
        ...
        {/* FIX: Safe light/dark mode color transitioning back link */}
        ...
        {/* FIX: Layout Card Component
          Swapped hardcoded dark backgrounds for adaptive Tailwind classes 
          (e.g., bg-white dark:bg-[#1a1a1e] and adaptive border tokens).
        */}
